...
# La classe EarliestTimingSolver contient toutes les données 
# nécessaires à la résolution du problème de timing pour seqata.
# Utilise la statégie de placement au plus tôt pour un ordre 
# d'avions donné
